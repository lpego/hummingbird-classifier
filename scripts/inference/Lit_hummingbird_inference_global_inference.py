...
for i, k in enumerate(top_K):
    ...
    print(
        f"PROBA top_K: {k} : precision {precision:.2f}, recall {recall:.2f}, F1 {F1:.2f}, TNR {tnr:.2f}"
    )
    ...
    print(
        f"SCORE top_K: {k} : precision {precision:.2f}, recall {recall:.2f}, F1 {F1:.2f}, TNR {tnr:.2f}"
    )
    del F1, recall, precision, tnr
    ...
    print(
        f"TRIPL top_K: {k} : precision {precision:.2f}, recall {recall:.2f}, F1 {F1:.2f}, TNR {tnr:.2f}"
    )
    del F1, recall, precision, tnr
